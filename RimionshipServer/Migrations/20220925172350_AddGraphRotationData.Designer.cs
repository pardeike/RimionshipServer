...
namespace RimionshipServer.Migrations
{
    ...
    [Migration("20220925172350_AddGraphRotationData")]
    partial class AddGraphRotationData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphDataGraphRotationData", b =>
                {
                    b.Property<int>("InRotationsId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ToRotateId")
                        .HasColumnType("INTEGER");

                    b.HasKey("InRotationsId", "ToRotateId");

                    b.HasIndex("ToRotateId");

                    b.ToTable("GraphDataGraphRotationData");
                });
            ...
            modelBuilder.Entity("RimionshipServer.Data.GraphRotationData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("TimeToDisplay")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.ToTable("GraphRotationData");
                });
            ...
            modelBuilder.Entity("GraphDataGraphRotationData", b =>
                {
                    b.HasOne("RimionshipServer.Data.GraphRotationData", null)
                        .WithMany()
                        .HasForeignKey("InRotationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RimionshipServer.Data.GraphData", null)
                        .WithMany()
                        .HasForeignKey("ToRotateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
