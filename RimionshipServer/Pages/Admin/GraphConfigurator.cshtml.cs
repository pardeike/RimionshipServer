...
namespace RimionshipServer.Pages.Admin
{
    ...
    public class GraphConfigurator : PageModel
    {
        ...
        public static readonly Dictionary<string, string> StatsNames = new()
        {
            ...
            { nameof(Stats.DownedColonists), "Bewusstlose Kolonisten" },
            ...
            { nameof(Stats.Electricity), "Strom" },
            ...
            { nameof(Stats.NumRaidsEnemy), "Raids" },
            { nameof(Stats.NumThreatBigs), "Gefahren" },
            { nameof(Stats.ColonistsKilled), "Verluste" },
            { nameof(Stats.GreatestPopulation), "Max Population" },
